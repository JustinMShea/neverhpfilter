...
employ_trend <- yth_filter(log_Employment, h = 8, p = 4, extract = "yth_trend", family = gaussian)
...
```{r, warning = FALSE}
employ_cycle <- yth_filter(log_Employment, h = 8, p = 4, extract = "yth_cycle", family = gaussian)
...
gdp_cycle <- yth_filter(log_RGDP, h = 8, p = 4, extract = "yth_cycle", family = gaussian)
