...
Presenting Hamilton's results, which are stored as a `data.table` in this package.
...
I replicate the table with base R functions and the results of the using `yth_filter` function on `100 * log` of `PAYEMS` and `GDPC1` earlier in the vignette.
