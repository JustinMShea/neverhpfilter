...
```{r, warning = FALSE, message = FALSE, caption = "Comparison table: Hamilton vs neverhpfilter"}
 # Combined table
combined_table <- rbind(Hamilton_table_2, my_table_2)
combined_table <- combined_table[order(combined_table$gdp.cor, decreasing = TRUE),]
kable(combined_table, align = 'l', caption = "Hamilton's table 2 compared with estimates from neverhpfilter::yth_filter")
```
