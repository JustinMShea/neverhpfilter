...
Turning the page, we find a similar graph of the cyclical component of Real Gross Domestic Product ( $100 * log($`GDPC1`$)$) superimposed with it's random walk representation. (Hamilton 45).
