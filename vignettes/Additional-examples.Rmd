...
Additional parameters supported by the `glm` function can be used as well. An example ussing a different error distribution, defined with the `family` arguement, is illustrated below.
