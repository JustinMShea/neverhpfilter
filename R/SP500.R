...
#' 
#' SP500_trend <- yth_filter(log_SP500, h = 8, p = 4, output = c("x", "trend"), family = gaussian)
#' 
#' main <- "Log of SP500 and trend"
#' plot(SP500_trend, grid.col = "white", legend.loc = "topleft", main = main)
#' 
#' 
#' SP500cycle <- yth_filter(log_SP500["1900/"], h = 8, p = 4, output = c("cycle", "random"), family = gaussian)
#' 
